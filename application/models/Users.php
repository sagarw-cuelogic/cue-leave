...
class Users extends CI_Model
{
    ...
    /**
     * Function to get the manager employees
     * @param type $manager_id
     * @return type
     */
    public function getManagerEmployees($manager_id)
    {
     ...
     * @return type
     */
    public function getAllManagerEmployees()
    {
          ...
          $sql = "SELECT CONCAT(e.first,' ',e.last) as employee_name ,
                  ...
                  LEFT JOIN designations d   ON ( m.designation=d.designation_id) 
    ...
    /**
     * Function to get managers by user id
     * @param type $user_id
     * @return type
     */
    public function getManagers($user_id)
    {
        ...
        $where  = array("designations.designation_name"=>'Project Manager'
                       ,'google_account.id !'=>$user_id);
        $user_data = $this->get_user_data($where);
        return $user_data;
    }
    /**
     ...
     * @return type
     */
    public function get_user_data($where_filters = NULL)
    {

        $sql = "SELECT * FROM google_account LEFT JOIN designations 
               ON (google_account.designation = designations.designation_id) ";
     ...
     * currently not using these function as we add user
     * directly once we login by google account
     * @param type $input_data
     * @return type
     */
    public function add_new_user($input_data)
    {
     ...
     * @return type
     */
    public function update_profile($input_data)
    {
     ...
     * @return type
     */
    public function update_profile_picture($input_data)
    {
    ...
    /**
     * Function to assign user a manager
     * @param type $manager_id
     * @param type $user_id
     * @return type
     */
    public function assign_user_to_manager($manager_id, $user_id)
    {
