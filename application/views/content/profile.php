<div class="col-md-11 col-sm-11 pull-left profile">
	<div class="panel panel-primary">
		...
		<?}?>
		<form class="profile_form form-horizontal" data-toggle="validator" role="form" method="POST" action="<?=base_url()?>user/update_profile">
		<div class="form-group padding-10 input-login">
		<div class="form-group">
			<label class="col-sm-3 control-label text-left">First Name</label>
			<div class="col-sm-9">
				<input type="text" class="form-control" id="first" name="first" value="<?=$user_data->first?>" required/>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="last" name="last" value="<?=$user_data->last?>" required/>
				<div class="help-block with-errors text-left"></div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<textarea class="form-control" id="address" name="address" required><?=$user_data->address?></textarea>
				<div class="help-block with-errors text-left"></div>
			</div>
		</div>
