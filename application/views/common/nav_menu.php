...
<ul class="nav nav-pills nav-stacked">
  ...
  <li role="presentation" class="<?=($navigation=='view_leaves')?'active':''?>"><a href="<?=base_url();?><?=$controller?>/landing/view_leaves">View Leaves <span class="glyphicon glyphicon-th-list pull-right" aria-hidden="true"></span></a></li>
   ...
   <li role="presentation" class="<?=($navigation=='view_employees')?'active':''?>"><a href="<?=base_url();?><?=$controller?>/landing/view_employees">Manager Employees <span class="glyphicon glyphicon-th-list pull-right" aria-hidden="true"></span></a></li>
